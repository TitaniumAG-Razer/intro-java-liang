...
/**
 * Compute taxes for all filing status.
 * @author Kevin
 *
 */
...
public class Exercise13 {
	public static void main(String[] args) {
		...
		else if (status == 1) { // Compute taxes for married filing jointly/widows
			if (income <= 16700)
				tax = income * 0.10;
		...
		System.out.println(NumberFormat.getNumberInstance(Locale.US).format((int)(tax * 100) / 100.00));
		input.close();
	}
}